...
tags: [android]
description: >-
  Your app can handle a link, but you want it to open in another app instead.
  A look at how Android resolves implicit Intents, and how to route one past
  your own app's intent filters.
---
